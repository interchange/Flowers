use utf8;
package IC6::Schema::Result::Address;
...
Related object: L<IC6::Schema::Result::OrderlinesShipping>

=cut

__PACKAGE__->has_many(
  "orderlines_shippings",
  "IC6::Schema::Result::OrderlinesShipping",
...
Related object: L<IC6::Schema::Result::User>
