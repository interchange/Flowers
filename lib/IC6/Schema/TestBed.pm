...
sub make_cart_product {
    use IC6::Schema::Result::CartProduct;
...
sub make_group_pricing {
    use IC6::Schema::Result::GroupPricing;
...
sub make_inventory {
    use IC6::Schema::Result::Inventory;
...
sub make_media_display {
    use IC6::Schema::Result::MediaDisplay;
...
sub make_media_product {
    use IC6::Schema::Result::MediaProduct;
...
sub make_media_type {
    use IC6::Schema::Result::MediaType;
...
sub make_merchandising_attribute {
    use IC6::Schema::Result::MerchandisingAttribute;
...
sub make_merchandising_product {
    use IC6::Schema::Result::MerchandisingProduct;
...
sub make_navigation {
    use IC6::Schema::Result::Navigation;
...
sub make_navigation_product {
    use IC6::Schema::Result::NavigationProduct;
...
sub make_permission {
    use IC6::Schema::Result::Permission;
...
sub make_orderline {
    use IC6::Schema::Result::Orderline;
...
sub make_orderline_shipping {
    use IC6::Schema::Result::OrderlinesShipping;
...
sub make_payment_order {
    use IC6::Schema::Result::PaymentOrder;
...
sub make_product {
    ...
    use IC6::Schema::Result::ProductClass;
...
sub make_product_attribute {
    use IC6::Schema::Result::ProductAttribute;
...
sub make_products_attributes {
    use IC6::Schema::Result::ProductAttributes;
...
sub make_user_attribute {
    use IC6::Schema::Result::UserRole;
